...
function buildWalkthrough(cfg) {
  ...
  frames.push({
    ...
    caption_layperson:
      `Let's start! Banks ${setStr(seed)} are hit by the initial shock and fail. ` +
      `They are marked in dark grey. All other banks are still healthy. ` +
      `We want to see if this initial failure spreads.`,
