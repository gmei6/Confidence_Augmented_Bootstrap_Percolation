"""
Task O follow-up analysis (Q5, C-Q5(ii)): duration dichotomy readout.

Reads results/q5_duration_raw.json and computes, per (n, field, mu) cell:
...
Writes results/processed/task_o_duration_analysis.json.
"""
...
RAW_PATH = "results/q5_duration_raw.json"
OUTPUT_PATH = "results/processed/task_o_duration_analysis.json"
...
def main():
    ...
    out = {
        "metadata": {
            "task": "O follow-up analysis (Q5 C-Q5(ii) duration dichotomy)",
